...
def main():
    ...
    os.makedirs(os.path.join(basedir, 'masks_v1'), exist_ok=True)
    ...
    for cam in cameras:
        os.makedirs(os.path.join(basedir, 'masks_v1', cam), exist_ok=True)
    ...
    # Load meta_data.json
    # -----------------------------
    with open(os.path.join(basedir, "meta_data_v4.json")) as f:
    ...
    for f in meta_data['frames']:
        ...
        save_path = os.path.join(basedir, rgb_path.replace('images', 'masks_v1'))
        np.save(
