...
MAX_FRAMES = 98          # hardcoded: max number of frames to use
# =========================
...
if __name__ == "__main__":
    ...
    overlay_root = os.path.join(out_dir, "debug_3d_overlays_v9")
    ...
    out_ply = os.path.join(out_dir, "points3d_v9.ply")  # cam_1, cam_2, cam_3 in this script
    ...
    # v10: 98 frames, 1 cam, print out the masks.
