...
MAX_FRAMES = None          # hardcoded: max number of frames to use
# =========================
...
if __name__ == "__main__":
    ...
    overlay_root = os.path.join(out_dir, "debug_3d_overlays_v10")
    ...
    out_ply = os.path.join(out_dir, "points3d_v10.ply")  # cam_1, cam_2, cam_3 in this script
