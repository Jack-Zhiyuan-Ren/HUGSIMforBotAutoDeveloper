...
def main():
    ...
    parser.add_argument("--base_cfg", type=str, default="./configs/waymo_gs_base.yaml") #changed to waymo from nusc
    parser.add_argument("--data_cfg", type=str, default="./configs/waymo.yaml") #change to waymo from nusc
